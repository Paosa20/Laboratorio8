...
import com.example.contacts.ContactsAPI.repository.ContactRepository;
...
public class ContactController {
    ...
    update(@PathVariable("id") long id,  @RequestBody Contact contact){
        return repository.findById(id).map(record -> {record.setName(contact.getName());
